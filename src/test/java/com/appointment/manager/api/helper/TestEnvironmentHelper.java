 ...
 *   &#064;Rule
 *   public final TestEnvironmentHelper environment = new TestEnvironmentHelper();
 *
 *   &#064;Test
 *   public void test() {
 ...
 * such modifications.
 */
public class TestEnvironmentHelper implements TestRule {
    /**
    ...
    public Statement apply(Statement base, Description description) {
        return new TestEnvironmentHelper.EnvironmentVariablesStatement(base);
    }
